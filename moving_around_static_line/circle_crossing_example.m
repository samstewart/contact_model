...
% todo: store everything in polygon form? We don't need anything special yet from the ellipses
fun_simulation(ellipses, [], @(ellipses) velocity_pointing_at_point(ellipses(:, 2), -initial_positions, speeds), 1, 2)
toc
